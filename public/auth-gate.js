(function(){
  ...
  function redirectEndpoint(endpoint){return endpoint+'?redirect_to='+encodeURIComponent(location.origin+'/')}
  function mount(){
    css();
