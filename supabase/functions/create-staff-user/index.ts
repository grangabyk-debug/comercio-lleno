...
Deno.serve(async(req:Request)=>{
  ...
  try{
    ...
    if(merr||!me||me.role!=='owner'||me.active!==true||!me.company_id)return json(req,{error:'Sólo el propietario activo puede crear usuarios'},403)
    ...
    return json(req,{ok:true,id:created.user.id,username,role})
