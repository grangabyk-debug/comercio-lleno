...
@media(max-width:620px){.pmcv-perspective-host{margin:12px auto!important}.pmcv-glass-story{padding:26px 16px;border-radius:28px;min-height:0}.pmcv-glass-copy h2{font-size:36px!important}.pmcv-glass-copy>p{font-size:12px!important}.pmcv-glass-canvas{min-height:510px}.pmcv-glass-halo{width:300px;height:300px}.pmcv-glass-source{width:145px;height:145px;border-radius:39px}.pmcv-glass-source::before{border-radius:31px}.pmcv-glass-lens{width:min(225px,74vw);padding:15px 16px}.pmcv-glass-lens>b{font-size:17px}.pmcv-glass-lens.ats{left:0;top:10px}.pmcv-glass-lens.selection{right:0;top:177px}.pmcv-glass-lens.area{left:4%;bottom:5px}}
