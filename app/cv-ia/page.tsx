...
.pmcv-shell [class*="plansGrid"]{max-width:1060px!important;gap:13px!important}
...
@media(min-width:860px){.pmcv-shell [class*="plansGrid"]{grid-template-columns:repeat(3,minmax(0,1fr))!important}.pmcv-shell [class*="filterGrid"]{grid-template-columns:repeat(3,minmax(0,1fr))!important}}
