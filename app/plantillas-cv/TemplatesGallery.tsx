...
export default function TemplatesGallery(){
 const [selected,setSelected]=useState('pm04')
 const current=useMemo(()=>getPostulaTemplate(selected)||POSTULA_TEMPLATES[0],[selected])
