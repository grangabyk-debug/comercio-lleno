...
const ELIGIBLE=new Set(['seleccion','escala','empresa'])
...
export async function GET(req:NextRequest){
 ...
 const row=await refreshPending(raw)
 ...
 return NextResponse.json({
  ...
  pending_plan:row?.pending_plan||null,
  pending_started_at:row?.pending_started_at||null,
