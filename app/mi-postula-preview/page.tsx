...
export default async function CandidatePage(){const jobs=await getJobCatalog();return <main className={`${styles.page} pm7-page`}><PlatformHeader/><CandidateActivationGate jobCount={jobs.length}/><CandidatePhoto/><CandidatePrivacyPanel/><NotificationSettings audience="candidate"/><FlexFavorites/><NativeApplications/><PlatformFooter/><MobileNav active="cuenta"/></main>}
