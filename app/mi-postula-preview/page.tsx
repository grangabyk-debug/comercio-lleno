...
export const metadata={title:'Mi perfil | Postulá Mejor',robots:{index:false,follow:false}}
export const revalidate=300
export default async function CandidatePage(){const jobs=await getJobCatalog();return <main className={`${styles.page} pm7-page`}><PlatformHeader/><CandidateDashboard jobCount={jobs.length}/><NativeApplications/><PlatformFooter/><MobileNav active="cuenta"/></main>}
