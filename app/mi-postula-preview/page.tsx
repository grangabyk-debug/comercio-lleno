...
export default async function CandidatePage(){const jobs=await getJobCatalog();return <main className={`${styles.page} ${styles.dashboard} pm-candidate-dashboard-v5`}><PlatformHeader/><CandidateDashboard jobCount={jobs.length}/><MobileNav active="cuenta"/></main>}
