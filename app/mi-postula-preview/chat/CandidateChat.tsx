...
const demoThread:Thread={id:'demo',conversation_kind:'application',pm_companies:{name:'Café Norte'},pm_applications:{status:'viewed',pm_jobs:{title:'Barista · Palermo'}}}
