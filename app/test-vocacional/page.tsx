...
export default function VocationalTestPage(){return <><VocationalTestClient/><footer style={{maxWidth:1040,margin:'-55px auto 45px',padding:'0 18px',fontFamily:'Inter,system-ui,sans-serif',fontSize:10,lineHeight:1.55,color:'#646a71'}}><b style={{color:'#30353c'}}>Base metodológica:</b> esta experiencia es una adaptación orientativa propia del marco RIASEC/Holland. El O*NET Interest Profiler utiliza ese mismo marco y cuenta con investigación psicométrica publicada por O*NET con participación de investigadores de University of Illinois. <a href="https://www.onetcenter.org/reports/IP_Manual.html" target="_blank" rel="noreferrer" style={{color:'#4d3fd2',fontWeight:800}}>Manual O*NET</a> · <a href="https://www.onetcenter.org/reports/IP_RVS.html" target="_blank" rel="noreferrer" style={{color:'#4d3fd2',fontWeight:800}}>Confiabilidad y validez</a></footer></>}
