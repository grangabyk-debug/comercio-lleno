...
function EmployerHeader(){
  return <header className="pm-employer-topbar"><div className="pm-employer-topbar-inner"><Link href="/empresas" className="pm-employer-wordmark" aria-label="PostulaMejor.com Empresas"><span className="pm-employer-brand-copy"><strong>PostulaMejor.com</strong><small>EMPRESAS</small></span></Link><nav className="pm-employer-topbar-nav" aria-label="Navegación de empresas"><Link href="/servicios-flex" className="pm-employer-flex-link">Servicios Flex</Link><AuthenticatedNavItems audience="employer" calendarClassName="pm-employer-flex-link"/><Link href="/" className="pm-employer-switch">Busco trabajo</Link><AccountNavLink audience="employer" className="pm-employer-account"/></nav></div></header>
}
