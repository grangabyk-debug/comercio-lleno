...
export const previewGigs:PreviewGig[]=[
 {id:'tecnico-aire-caba',title:'Instalo y reparo aires acondicionados',category:'Casa y arreglos',location:'CABA y GBA',when:'Disponibilidad esta semana',pay:'Desde $35.000',duration:'Turnos a coordinar',poster:'Martín R.',posterRole:'Vista ilustrativa · publicación de muestra',rating:'nuevo',verified:false,image:'https://images.pexels.com/photos/8005397/pexels-photo-8005397.jpeg?auto=compress&cs=tinysrgb&w=900',summary:'Soy técnico en refrigeración. Hago instalación, mantenimiento y reparación de equipos split e inverter. Presupuesto según equipo y zona.',requirements:['Consultar disponibilidad antes de coordinar','Confirmar modelo y falla del equipo','El presupuesto final se acuerda antes del servicio'],tags:['Técnico','Aire acondicionado','CABA','Presupuesto'],listingType:'offer'},
