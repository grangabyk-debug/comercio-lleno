...
export const previewGigs:PreviewGig[]=[
 ...
 {id:'paseo-perro-belgrano',title:'Pasear a Milo durante la semana',category:'Mascotas',location:'Belgrano · CABA',when:'Lun a vie · 13:00',pay:'$9.000 / paseo',duration:'45 min',poster:'Ejemplo',posterRole:'Vista ilustrativa · no es una publicación real',rating:'nuevo',verified:false,image:'https://images.pexels.com/photos/7210748/pexels-photo-7210748.jpeg?auto=compress&cs=tinysrgb&w=900',summary:'Busco una persona responsable para paseo al mediodía. Milo es mediano, sociable y tiene correa.',requirements:['Buen trato con animales','Puntualidad','Zona Belgrano / Núñez'],tags:['Ejemplo','Recurrente','Mascotas','Mediodía']},
 {id:'ayuda-evento-san-telmo',title:'Ayuda en evento de marca',category:'Eventos',location:'San Telmo · CABA',when:'Viernes · 18:00 a 00:00',pay:'$46.000',duration:'6 h',poster:'Ejemplo',posterRole:'Vista ilustrativa · no es una publicación real',rating:'nuevo',verified:false,image:'https://images.pexels.com/photos/1190297/pexels-photo-1190297.jpeg?auto=compress&cs=tinysrgb&w=900',summary:'Recepción de invitados, entrega de acreditaciones y apoyo general durante un lanzamiento.',requirements:['Buena presencia y trato','Llegar 30 min antes','Vestimenta negra lisa'],tags:['Ejemplo','Evento','Viernes','Noche']},
 ...
 {id:'cocina-cumple-boedo',title:'Ayudante de cocina para cumpleaños',category:'Gastronomía',location:'Boedo · CABA',when:'Domingo · 16:00 a 22:00',pay:'$48.000',duration:'6 h',poster:'Ejemplo',posterRole:'Vista ilustrativa · no es una publicación real',rating:'nuevo',verified:false,image:'https://images.pexels.com/photos/4252139/pexels-photo-4252139.jpeg?auto=compress&cs=tinysrgb&w=900',summary:'Apoyo para preparar, ordenar y servir comida en un cumpleaños familiar de 35 personas.',requirements:['Experiencia básica de cocina','Orden e higiene','Llegar puntual'],tags:['Ejemplo','Domingo','Cocina','Evento']},
 {id:'clases-compu-adulto-mayor',title:'Enseñar WhatsApp y trámites digitales',category:'Clases particulares',location:'Flores · CABA',when:'A coordinar',pay:'$18.000 / clase',duration:'1 h',poster:'Ejemplo',posterRole:'Vista ilustrativa · no es una publicación real',rating:'nuevo',verified:false,image:'https://images.pexels.com/photos/7551617/pexels-photo-7551617.jpeg?auto=compress&cs=tinysrgb&w=900',summary:'Buscamos alguien paciente para enseñar uso básico del celular, WhatsApp, turnos y pagos simples.',requirements:['Paciencia','Explicar sin apuro','Preferencia por encuentros presenciales'],tags:['Ejemplo','Flexible','Ayuda','1 hora']},
]
