...
export default function NotificationSettings({audience='candidate'}:{audience?:'candidate'|'employer'}){
 ...
 return <section className="pm16-notifications" aria-labelledby={`pm16-title-${audience}`}>
  ...
  <div className="pm16-notif-grid">
   <article className="pm16-notif-row locked"><div><span className="pm16-notif-icon">✦</span><div><b>Mensajes y contactos</b><p>{audience==='employer'?'Cuando un candidato te escribe o responde':'Cuando una empresa o persona te contacta por una postulación o Servicios Flex'}</p></div></div><span className="pm16-always">Siempre activo</span></article>
   ...
   <article className="pm16-notif-row locked"><div><span className="pm16-notif-icon">⌾</span><div><b>Seguridad de la cuenta</b><p>Accesos, recupero, cambios críticos y avisos necesarios para proteger la cuenta.</p></div></div><span className="pm16-always">Siempre activo</span></article>
  </div>
