...
const features:Feature[]=[
  {key:'vender',label:'Vender',eyebrow:'01 · VENTAS Y CAJA',title:'Cobrar tiene que ser la parte fácil.',body:'Buscá o escaneá productos, elegí el medio de pago y cerrá la venta sin saltar entre pantallas.',image:'https://images.pexels.com/photos/33752264/pexels-photo-33752264.jpeg?auto=compress&cs=tinysrgb&w=1800',alt:'Interacción en un comercio de Buenos Aires',points:['Venta rápida','Caja diaria','Descuentos y promociones'],metric:'1 flujo',metricLabel:'de producto a cobro'},
  {key:'stock',label:'Stock',eyebrow:'02 · PRODUCTOS',title:'El stock acompaña la venta. No va por separado.',body:'Consultá existencias, actualizá precios y detectá productos bajos sin perder tiempo armando planillas paralelas.',image:'https://images.pexels.com/photos/12326636/pexels-photo-12326636.jpeg?auto=compress&cs=tinysrgb&w=1800',alt:'Comerciante gestionando un almacén de cercanía',points:['Stock en tiempo real','Carga y edición rápida','Alertas de bajo stock'],metric:'Siempre',metricLabel:'inventario a mano'},
  {key:'arca',label:'Facturar',eyebrow:'03 · ARCA',title:'La factura sale dentro de la misma venta.',body:'Una vez configurado el certificado y el punto de venta, el proceso fiscal queda integrado al trabajo diario.',image:'https://images.pexels.com/photos/12935050/pexels-photo-12935050.jpeg?auto=compress&cs=tinysrgb&w=1800',alt:'Sistema de punto de venta en un comercio de alimentos',points:['Factura electrónica','Punto de venta configurado','Comprobantes desde el sistema'],metric:'ARCA',metricLabel:'integrado al POS'},
