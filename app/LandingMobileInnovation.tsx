...
const mobilePhoto='https://images.pexels.com/photos/4921262/pexels-photo-4921262.jpeg?auto=compress&cs=tinysrgb&w=1900'
...
export default function LandingMobileInnovation(){
  return <section className={styles.section} id="movil" aria-labelledby="mobile-title">
    <div className={styles.poster}>
      ...
      <img src={mobilePhoto} alt="Comerciante realizando un cobro desde un dispositivo móvil"/>
      <PhonePreview/>
    ...
    <div className={styles.copy}>
      ...
      <p className={styles.lead}>No es una web de escritorio apretada dentro del teléfono. Diseñamos otra forma de trabajar: menos pantalla, más mostrador.</p>
