...
export const metadata:Metadata={
 ...
 description:'36 plantillas de currículum originales y rediseñadas. Doce gratuitas y 24 incluidas con CV Pro+. Descargá Word editable y volvé a analizarlo sin perder el modelo.',
 alternates:{canonical:'https://postulamejor.com/plantillas'},
 robots:{index:true,follow:true},
 openGraph:{title:'36 plantillas de CV atractivas | Postulá Mejor',description:'12 modelos gratis y 24 diseños CV Pro+ para descargar y editar en Word.',url:'https://postulamejor.com/plantillas',siteName:'Postulá Mejor',type:'website',locale:'es_AR'},
