  ...
  return <>
    ...
    {open&&<div className={styles.backdrop} onMouseDown={event=>{if(event.target===event.currentTarget)setOpen(false)}}>
      <div className={styles.modal} role="dialog" aria-modal="true" aria-label="Demo interactiva de Comercio Lleno">
        ...
        {!paid?<div className={styles.posShell}>
        ...
        </div>:<div className={styles.successScene}>
        ...
        <div className={styles.foot}><div className={styles.steps}><span className={itemCount?styles.stepDone:''}><b>1</b> Productos</span><span className={itemCount?styles.stepDone:''}><b>2</b> Pago</span><span className={paid?styles.stepDone:''}><b>3</b> Ticket</span></div><Link href="/prueba-gratis">Empezar prueba gratis →</Link></div>
      </div>
    </div>}
  </>
}
