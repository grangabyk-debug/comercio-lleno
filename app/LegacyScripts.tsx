...
function isolatedProduct(pathname:string){
  return pathname.startsWith('/cv-ia')||pathname.startsWith('/cuenta')||pathname.startsWith('/mi-cv')||pathname.startsWith('/busqueda-activa')
}

export default function LegacyScripts() {
  const pathname = usePathname()
  if (pathname.startsWith('/redesign') || pathname.startsWith('/movil') || isolatedProduct(pathname)) return null
