...
export const metadata:Metadata={
 ...
 openGraph:{title:'30 plantillas de CV atractivas | Postulá Mejor',description:'Modelos gratuitos y diseños CV Pro+ para descargar y editar en Word.',url:'https://postulamejor.com/plantillas',siteName:'Postulá Mejor',type:'website',locale:'es_AR'},
