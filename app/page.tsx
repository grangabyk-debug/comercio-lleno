...
export default function LandingPage(){
  ...
  return <main className={styles.page}>
    ...
    <section className={styles.humanMosaic}><div className={styles.humanIntro}><p>HECHO PARA NEGOCIOS REALES</p><h2>El mismo sistema puede acompañar formas muy distintas de trabajar.</h2></div><div className={styles.mosaicGrid}><figure><img src={villageShopPhoto} alt="Dueño trabajando en un almacén de cercanía"/><figcaption><b>Almacenes y comercios de cercanía</b><span>Mostrador, productos, ventas, stock y caja.</span></figcaption></figure><figure><img src={furniturePhoto} alt="Personas trabajando en un showroom"/><figcaption><b>Showrooms y locales</b><span>Catálogo, stock, precios y seguimiento.</span></figcaption></figure><figure><img src={bakeryPhoto} alt="Local minorista atendiendo clientes"/><figcaption><b>Comercios de alto movimiento</b><span>Velocidad de mostrador y facturación.</span></figcaption></figure></div></section>
