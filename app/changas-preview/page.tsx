...
import FlexMessageModalPolish from './FlexMessageModalPolish'
...
import './flex-mobile-marketplace.css'
import './flex-message-modal-v48.css'
...
export default function ServiciosFlexPage(){return <main className={`${styles.page} pm7-page pm7-candidate`}>
 <PlatformHeader/><ServicesFlexLegalGuard/><FlexUxCleanup/><FlexUnifiedFilters/><FlexMessageModalPolish/>
