...
export default function ServiciosFlexPage(){return <main className={`${styles.page} pm7-page pm7-candidate`}>
 ...
 <section className="pm7-gig-explorer" id="explorar"><div className="pm7-section-head"><div><span className="pm7-eyebrow coral">TAREAS PUNTUALES</span><h2>Servicios Flex con contexto, no avisos crípticos.</h2></div><p>Las publicaciones reales aparecen primero. Si todavía no hay servicios activos, mostramos ejemplos claramente identificados para explicar la experiencia.</p></div><FlexManager/><ChangasExplorer gigs={previewGigs} categories={gigCategories}/></section>
