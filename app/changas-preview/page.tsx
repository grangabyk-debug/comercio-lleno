...
export default function ServiciosFlexPage(){return <main className={`${styles.page} pm7-page pm7-candidate`}>
 ...
 <section className="pm7-gig-explorer" id="explorar"><div className="pm7-section-head"><div><span className="pm7-eyebrow coral">TODOS LOS SERVICIOS FLEX</span><h2>Buscá, filtrá y recorré todas las publicaciones.</h2></div><p>Además de las categorías, ahora podés buscar por palabra, zona, fecha y tipo de publicador. Las publicaciones reales aparecen primero y los ejemplos se identifican claramente.</p></div><FlexManager/><ChangasExplorer gigs={previewGigs} categories={gigCategories}/></section>
