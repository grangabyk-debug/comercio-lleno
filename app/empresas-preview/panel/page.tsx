...
export default function EmployerPanel(){return <main className={`${styles.page} ${styles.dashboard} pmv5-employer pm-employer-dashboard-v5`}><PlatformHeader audience="employer"/><EmployerDashboard/></main>}
