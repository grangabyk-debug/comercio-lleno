...
export default function PublishPage(){return <main className={`${styles.page} pm7-page pm7-employer`}><PlatformHeader audience="employer"/><div className={styles.wizard}><EmployerPublishWizard/></div><PlatformFooter/><SupportHelp audience="employer"/></main>}
