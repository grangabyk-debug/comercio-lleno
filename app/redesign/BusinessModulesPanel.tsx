...
const card:React.CSSProperties={border:'1px solid #dfe7e2',borderRadius:20,padding:18,background:'#fff',boxShadow:'0 8px 30px rgba(20,45,34,.05)',display:'grid',gap:14}
const label:React.CSSProperties={fontSize:12,fontWeight:850,display:'grid',gap:7,color:'#26362f'}
const input:React.CSSProperties={height:42,border:'1px solid #cad7d0',borderRadius:11,padding:'0 12px',fontWeight:750,background:'#fff',color:'#17251f'}
const pill:React.CSSProperties={height:34,borderRadius:999,border:'1px solid #cfd9d4',background:'#fff',fontSize:11,fontWeight:850,padding:'0 12px',cursor:'pointer'}
