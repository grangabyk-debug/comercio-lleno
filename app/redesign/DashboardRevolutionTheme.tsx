...
main[class*="shell"][class*="dark"]{--bg:#100d12;--surface:#19151c;--surface2:#211b25;--line:#342c39;--text:#f7f2f8;--muted:#a79caa;background:#100d12!important;color:#f7f2f8!important}
...
main[class*="shell"][class*="dark"]>header[class*="topbar"] [class*="headerButton"],main[class*="shell"][class*="dark"]>header[class*="topbar"] [class*="versionPill"]{background:#211b25!important;border-color:#3b3141!important;color:#d8cedd!important}
