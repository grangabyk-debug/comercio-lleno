    ...
    <section className={styles.shell}>
      <aside className={styles.visual}>
        ...
        <div className={styles.visualCopy}>
          ...
          <p>Ventas, stock, caja, facturación y asistencia inteligente desde el mismo lugar.</p>
        </div>
      ...
      <section className={styles.card}>
        ...
        <div className={styles.copy}>
          <p className={styles.eyebrow}>COMERCIO LLENO</p>
          <h1>{recovery ? 'Recuperá tu contraseña' : 'Entrá a tu comercio'}</h1>
          <p>{recovery ? 'Ingresá el email de la cuenta propietaria. Si existe una cuenta, vas a recibir un enlace para elegir una contraseña nueva.' : 'Usá tu email de propietario o el usuario que te asignaron en el comercio.'}</p>
        </div>
