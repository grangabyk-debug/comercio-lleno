...
export default function RedesignPage() {
  ...
  return <><HeaderRefreshBehavior/><MobileResponsiveFix/><ViewScrollReset/><DesignRuntime/><RedesignBrandOverlay/><TrialStatus/><OnboardingGuide/><CommerceApp buildVersion={buildVersion}/></>
}
