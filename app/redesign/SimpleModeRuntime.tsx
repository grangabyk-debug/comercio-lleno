...
export default function SimpleModeRuntime(){
  ...
  return <>
    <style>{`html[data-simple-mode="1"] main[class*=shell] aside[class*=sidebar]{display:none!important}html[data-simple-mode="1"] main[class*=shell] div[class*=layout]{grid-template-columns:1fr!important}html[data-simple-mode="1"] main[class*=shell] section[class*=content]{max-width:none!important}`}</style>
